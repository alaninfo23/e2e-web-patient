...
export const PLEASE_WRITE_FULL_NUMBER_DECIMAL: string = "Please write the full number including the decimal.";
...
export const PLEASE_INSERT_VALUE_BETWEEN: string = "Please insert a value between ";
