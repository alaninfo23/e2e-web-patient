...
export const ONBOARDING_PRACTICE_SURVEY: string = "Onboarding Practice Survey";
export const HOW_HAS_YOUR_ONBOARDING_EXPERIENCE_BEEN_SO_FAR: string =
  "How has your onboarding experience been so far?";
export const PLEASE_PROVIDE_ANY_FEEDBACK: string =
  "Please provide any feedback as to what we could have done to make your onboarding experience better.";
